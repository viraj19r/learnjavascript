...
const showObject = array1.find((a) => {
  // find(all values of array, index, whole array)
  return a.planet === "earth";
});
//  earth.planet = "jupiter"; // it will returning the same object so we can change
//  console.log(earth);

const showIndex = array1.findIndex((b) => {
  // findIndex(all values of array, index, whole array)
